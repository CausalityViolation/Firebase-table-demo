...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/RJFbOh7bVA)
...
```sh
npx nx serve waitwhile-app
```

To create a production bundle:

```sh
npx nx build waitwhile-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project waitwhile-app
```
